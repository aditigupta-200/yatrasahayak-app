// File: screens/statistics_screen.dart
...
class _StatisticsScreenState extends State<StatisticsScreen> with SingleTickerProviderStateMixin {
  ...
  // Sample tourist data
  final Map<String, List<Map<String, dynamic>>> _touristData = {
    'Monthly': [
  ...
  final List<Map<String, dynamic>> _topDestinations = [
    {'name': 'Bali', 'country': 'Indonesia', 'growth': 24.5, 'color': Color(0xFF3B82F6)},
    {'name': 'Santorini', 'country': 'Greece', 'growth': 18.7, 'color': Color(0xFFF59E0B)},
    {'name': 'Kyoto', 'country': 'Japan', 'growth': 15.2, 'color': Color(0xFFEC4899)},
    {'name': 'Prague', 'country': 'Czech Republic', 'growth': 12.8, 'color': Color(0xFF10B981)},
    {'name': 'Barcelona', 'country': 'Spain', 'growth': 10.4, 'color': Color(0xFF8B5CF6)},
  ];
  ...
  // Build chart based on selected view
  Widget _buildChart(String view) {
    ...
    return BarChart(
      BarChartData(
        ...
        maxY: view == 'Monthly' ? 60000 : (view == 'Seasonal' ? 160000 : 180000),
          ...
          leftTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta) {
                ...
                if (view == 'Monthly') {
                  if (value == 0) text = '0';
                  else if (value == 20000) text = '20K';
                  else if (value == 40000) text = '40K';
                  else if (value == 60000) text = '60K';
                } else if (view == 'Seasonal') {
                  if (value == 0) text = '0';
                  else if (value == 50000) text = '50K';
                  else if (value == 100000) text = '100K';
                  else if (value == 150000) text = '150K';
                } else {
                  if (value == 0) text = '0';
                  else if (value == 60000) text = '60K';
                  else if (value == 120000) text = '120K';
                  else if (value == 180000) text = '180K';
                }
